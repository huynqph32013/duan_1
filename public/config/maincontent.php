        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-7 col-lg-6 py-8 text-md-start text-center">
              ...
              <h1 class="text-800 mb-5 fs-4">Chỉ vài cú nhấp chuột, hãy tìm những bữa ăn<br class="d-none d-xxl-block" />có thể truy cập được ở gần bạn</h1>
              <div class="card w-xxl-75">
                <div class="card-body">
                  <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <button class="nav-link active mb-3" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true"><i class="fas fa-motorcycle me-2"></i>Chuyển Tới</button>
                      <button class="nav-link mb-3" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="fas fa-shopping-bag me-2"></i>Địa điểm</button>
                    </div>
                  </nav>
                      ...
                      <form class="row gx-2 gy-2 align-items-center">
                        <div class="col">
                          <div class="input-group-icon"><i class="fas fa-map-marker-alt text-danger input-box-icon"></i>
                            ...
                            <input class="form-control input-box form-foodwagon-control" id="inputDelivery" type="text" placeholder="Địa chỉ của bạn" />
                          </div>
                        </div>
